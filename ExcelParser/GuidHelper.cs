...
namespace Artech.Common.Helpers.Guids
{
	public static class GuidHelper
	{
		...
		/// <param name="caseSensitive"><c>true</c> if the name must treated as a case sensitive one</param>
		/// <returns>A UUID derived from the namespace and name.</returns>
		/// <remarks>See <a href="http://code.logos.com/blog/2011/04/generating_a_deterministic_guid.html">Generating a deterministic GUID</a>.</remarks>
		public static Guid Create(Guid namespaceId, string name, bool caseSensitive)
		{
			return Create(namespaceId, caseSensitive ? name : name.ToUpper(), 5);
		}
